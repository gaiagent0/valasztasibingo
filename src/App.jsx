...
// ─── Modal ───────────────────────────────────────────────────────────────────
// FIX: overlay scrollable, close button always visible (sticky header inside modal)
  ...
  return (
    <div
      ...
      style={{
        ...
        overflowY: 'auto',           // overlay maga görget, nem a belső tartalom
        WebkitOverflowScrolling: 'touch',
        padding: '1rem',
        backdropFilter: 'blur(3px)',
      }}
    >
      {/* Vertikális középre igazítás — de csak ha van hely */}
      <div style={{ minHeight: '100%', display: 'flex', alignItems: 'flex-start', justifyContent: 'center', paddingTop: 8, paddingBottom: 8 }}>
        ...
        >
          ...
          {/* Sticky fejléc – tricolor csík + cím + bezárás */}
          <div style={{ flexShrink: 0, borderRadius: '16px 16px 0 0', overflow: 'hidden' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '1rem 1.25rem 0.75rem', background: 'white' }}>
              ...
              <button
                onClick={onClose}
                style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#9CA3AF', padding: '4px 6px', borderRadius: 8, display: 'flex', flexShrink: 0, marginLeft: 8 }}
                aria-label="Bezárás"
              >
                <X size={22} />
              </button>
    ...
    <Modal isOpen={isOpen} onClose={onClose} title="🗳️ Üdvözöl a Választási Bingó!">
      <div style={{ fontSize: 14, lineHeight: 1.7, color: '#374151' }}>
        ...
        <button onClick={onClose} style={{
          ...
          border: 'none', borderRadius: 10, fontSize: 15, fontWeight: 700, cursor: 'pointer', letterSpacing: 0.5
        }}>
...
export default function App() {
  ...
  return (
    // FIX: flexDirection column + minHeight 100dvh → footer mindig lent, görgetés után látható
    <div style={{ minHeight: '100dvh', display: 'flex', flexDirection: 'column', background: '#F9FAFB', fontFamily: "'Segoe UI', system-ui, sans-serif" }}>
      ...
      {/* Main – flex:1 hogy kitöltse a rendelkezésre álló helyet */}
      ...
      {/* Footer – FIX: flexShrink:0 → nem nyomódik el, mindig látható a tábla alatt */}
